    ...
    <div class="container container--with-sidebar">
        <header class="main-header">
            ...
            <div class="main-header__side">
                <a class="main-header__side-item button button--plus open-modal" href="http://localhost:82/things/?task=add">Добавить задачу</a>
...
<footer class="main-footer">
    <div class="container">
        ...
        <a class="main-footer__button button button--plus" href="http://localhost:82/things/?task=add">Добавить задачу</a>
